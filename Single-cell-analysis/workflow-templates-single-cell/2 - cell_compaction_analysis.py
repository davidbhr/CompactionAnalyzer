...
# maxproj
fiber_list = glob.glob(r"..//maxproj\Max_all\Day*\\Day*\*C003*.tif")
cell_list = glob.glob(r"..//maxproj\Max_all\Day*\\Day*\*C004*.tif")   #check that order is same to fiber



# create output folder accordingly
out_list = [os.path.join("out",cell_list[i].split(os.sep)[2], cell_list[i].split(os.sep)[3]) for i in range(len(cell_list))]
