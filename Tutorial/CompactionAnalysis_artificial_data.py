...
fiber_list_string =  r"ArtificialData\rand*.tif"
cell_list_string =  r"ArtificialData\*Cell*.tif"   # ExampleCell
...
output_folder = "ArtificialData_output" # base path to store results
...
SummarizeResultsTotal(data="ArtificialData_output", output_folder= "ArtificialData_output\Combine_Set1")
SummarizeResultsDistance(data="ArtificialData_output", output_folder= "ArtificialData_output\Combine_Set1")
